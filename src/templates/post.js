    ...
    return (
      <div css={{ position: `relative` }}>
        <Helmet>
          ...
          <meta
            name="description"
            content={`${this.removeEntities(post.excerpt)}`}
          />
          <meta
          ...
          <meta
            property="og:title"
            content={`${this.removeEntities(post.title)} - ${config.siteTitle}`}
          />
        ...
        >
          <h1
            ...
            dangerouslySetInnerHTML={{
              __html: this.removeEntities(post.title)
            }}
          />
          <PostIcons
            node={post}
            css={{ marginBottom: rhythm(1 / 2), textAlign: `center` }}
          />
        </div>
        <div
          {...boxedContent}
